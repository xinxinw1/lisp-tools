...
(function (win, udf){
  ...
  */
  ...
  function tobj(a, o){
    ...
    if (symp(a))return $.tobj(a, tobj(o));
  ...
  function jmat(a){
    if (nilp(a))return "";
    if (symp(a) || rgxp(a) || fnp(a))return a;
    if (strp(a))return rp(a);
  ...
  function ref1(a, n){
    ...
    if (symp(a))return chku($.ref(a, $.num(n)));
  ...
  function pos(x, a, n){
    ...
    if (lisp(a))return (function pos(x, a, n){
      if (udfp(n))n = "0";
      if (nilp(a))return "-1";
      if (!nilp(x(car(a))))return n;
      return pos(x, cdr(a), add(n, "1"));
    })(jn(x), ncdr(n, a));
    if (arrp(a))return $.str($.pos(jn(x), rp(a), $.num(n)));
    if (objp(a))return $.str($.pos(jn(x), a, $.num(n)));
    if (symp(a))return $.str($.pos(jmat(x), a, $.num(n)));
  ...
  function has(x, a){
    if (lisp(a))return (function has(x, a){
      ...
      if (!nilp(x(car(a))))return true;
      return has(x, cdr(a));
    })(jn(x), a);
    if (arrp(a))return $.has(jn(x), rp(a));
    if (objp(a))return $.has(jn(x), a);
    if (symp(a))return $.has(jmat(x), a);
  ...
  function all(x, a){
    if (lisp(a))return (function all(x, a){
      ...
      if (nilp(x(car(a))))return false;
      return all(x, cdr(a));
    })(jn(x), a);
    if (arrp(a))return $.all(jn(x), rp(a));
    if (objp(a))return $.all(jn(x), a);
    if (symp(a))return $.all(jmat(x), a);
  ...
  function keep(x, a){
    if (lisp(a))return (function keep(x, a){
      if (nilp(a))return [];
      if (nilp(x(car(a))))return keep(x, cdr(a));
      return cons(car(a), keep(x, cdr(a)));
    })(jn(x), a);
    if (symp(a))return $.keep(jmat(x), a);
    if (strp(a))return s(keep(x, rp(a)));
    if (objp(a))return $.keep(jn(x), a);
    if (arrp(a))return r($.keep(jn(x), rp(a)));
  ...
  function rem(x, a){
    if (lisp(a))return (function rem(x, a){
      if (nilp(a))return [];
      if (!nilp(x(car(a))))return rem(x, cdr(a));
      return cons(car(a), rem(x, cdr(a)));
    })(jn(x), a);
    if (symp(a))return $.rem(jmat(x), a);
    if (strp(a))return s(rem(x, rp(a)));
    if (objp(a))return $.rem(jn(x), a);
    if (arrp(a))return r($.rem(jn(x), rp(a)));
  ...
  function remb(x, a){
    if (lisp(a))return (function remb(x, a){
      if (nilp(a))return [];
      if (!nilp(x(car(a))))return remb(x, cdr(a));
      return a;
    })(jn(x), a);
  ...
  function rpl(x, y, a){
    if (lisp(a))return (function rpl(x, y, a){
      if (nilp(a))return [];
      return cons(!nilp(x(car(a)))?y:car(a), rpl(x, y, cdr(a)));
    })(jn(x), y, a);
    if (symp(a))return $.rpl(jmat(x), jmat(y), a);
    if (strp(a))return s(rpl(x, y, rp(a)));
    if (objp(a))return $.rpl(jn(x), y, a);
    if (arrp(a))return r($.rpl(jn(x), y, rp(a)));
  ...
  function len(a){
    ...
    if (symp(a) || objp(a))return $.str($.len(a));
  ...
  function emp(a){
    ...
    if (arrp(a) || symp(a) || strp(a) || fnp(a) || objp(a)){
      return is(len(a), "0");
    }
  ...
  function sli(a, n, m){
    ...
    if (udfp(m))m = len(a);
    if (symp(a))return $.sli(a, $.num(n), $.num(m));
  ...
  function spl(a, x){
    if (symp(a))return tlis(r($.spl(a, jmat(x))));
  ...
  function grp(a, n){
    if (!is(n, "0")){
      ...
      if (symp(a) || strp(a))return (function grp(a, n){
        if (emp(a))return [];
  ...
  function fla(a, x){
    if (udfp(x)){
      if (lisp(a))return rdc(app2, [], a);
      if (arrp(a))return rdc(app2, r([]), a);
      err(fla, "Can't flat a = $1", a);
    }
    if (lisp(a))return rdc(function (r, a){
      if (emp(r))return app(r, a);
      return app(r, x, a);
    }, [], a);
    if (arrp(a))return rdc(function (r, a){
      if (emp(r))return app(r, a);
      return app(r, x, a);
    }, r([]), a);
  ...
  function rdc(f, x, a){
    ...
    if (arrp(a))return $.rdc(jn(f), x, rp(a));
    if (objp(a))return $.rdc(jn(f), x, a);
  ...
  function rdc1(f, a){
    ...
    if (arrp(a))return $.rdc1(jn(f), rp(a));
  ...
  function beg(a){
    ...
    if (symp(a) || strp(a))return is(pos(r(x), a), "0");
  ...
  function stf(a){
    ...
    if (strp(a) || symp(a))return rdc1(function (s, x, i){
  ...
  function err(f, a){
    $.err(f, rp(apl(stf, r($.sli(arguments, 1)))));
  }
